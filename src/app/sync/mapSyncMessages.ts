...
export function parseMapSyncSocketMessage(raw: unknown): ParsedMapSyncMessage {
  ...
  switch (message.type) {
    ...
    case "sync_snapshot":
      return {
        type: "sync_snapshot",
        payload: message as MapSyncSnapshotMessage,
      };
    case "map_operation_applied":
      return {
        type: "map_operation_applied",
        payload: message as MapOperationMessage,
      };
    case "map_token_error":
      return {
        type: "map_token_error",
        payload: message as MapTokenErrorMessage,
      };
    case "map_token_updated":
      return {
        type: "map_token_updated",
        payload: message as MapTokenUpdatedMessage,
      };
    default:
      return { type: "unknown" };
  }
