...
import { applyOperationToWorld } from "@/domain/world/worldOperationApplier";
import type {
  FactionPatch,
  FeaturePatch,
  MapFeatureRecord,
...
function roadRecordsByKey(world: World): Map<string, MapRoadRecord> {
...
function roadRestoreOperations(targetWorld: World, currentWorld: World): MapOperation[] {
...
function factionPatchForPreviousValues(world: World, factionId: string, patch: FactionPatch): FactionPatch {
...
function inverseForOperation(worldBefore: World, operation: MapOperation): MapOperation[] {
...
export function invertOperationBatch(worldBefore: World, operations: MapOperation[]): MapOperation[] {
