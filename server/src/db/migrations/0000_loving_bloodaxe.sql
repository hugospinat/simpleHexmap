CREATE TYPE "public"."workspace_role" AS ENUM('owner', 'gm', 'player');--> statement-breakpoint
...
CREATE TABLE "factions" (
	...
	"name" text NOT NULL,
	"color" text NOT NULL,
	CONSTRAINT "factions_map_id_id_pk" PRIMARY KEY("map_id","id")
);
--> statement-breakpoint
...
ALTER TABLE "faction_territories" ADD CONSTRAINT "faction_territories_map_faction_fk" FOREIGN KEY ("map_id","faction_id") REFERENCES "public"."factions"("map_id","id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "faction_territories_faction_idx" ON "faction_territories" USING btree ("map_id","faction_id");--> statement-breakpoint
